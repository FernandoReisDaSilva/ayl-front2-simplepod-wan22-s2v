...
TEST_ID = "TEST_RUNPOD_LATENTSYNC_IMAGE_V1_1_ENTRYPOINT_R2_PROBE_0001"
REPO_ROOT = Path(__file__).resolve().parents[2]
ENV_PATH = REPO_ROOT / ".env"
GRAPHQL_ENDPOINT = "https://api.runpod.io/graphql"
OUTPUT_DIR = REPO_ROOT / "tmp" / "runpod_latentsync_image_v1_1_entrypoint_r2_probe_0001"
INTENDED_PAYLOAD_PATH = OUTPUT_DIR / "intended_payload.json"
LOCAL_FINAL_REPORT_PATH = OUTPUT_DIR / "output" / "final_report.json"
LOG_PATH = REPO_ROOT / "logs" / "runpod_latentsync_image_v1_1_entrypoint_r2_probe_0001_log.json"
...
DEFAULT_POD_NAME = "ayl-test-latentsync-image-v1-1-entrypoint-r2-probe-0001"
DEFAULT_IMAGE_TAG = "ghcr.io/fernandoreisdasilva/ayl-latentsync-runpod:0.1.1"
DEFAULT_CONTAINER_DISK_GB = 20
R2_PROGRESS_KEY = "tests/runpod_latentsync_image_v1_1/progress/container_started.json"
R2_FINAL_REPORT_KEY = "tests/runpod_latentsync_image_v1_1/output/final_report.json"
...
CREATE_POD_MUTATION = """
mutation TestRunpodLatentsyncImageV11EntrypointCreate0001($input: PodFindAndDeployOnDemandInput!) {
...
POD_STATUS_QUERY = """
query TestRunpodLatentsyncImageV11EntrypointStatus0001($podId: String!) {
...
mutation TestRunpodLatentsyncImageV11EntrypointTerminate0001($podId: String!) {
...
def redacted_env() -> list[dict]:
    return [
        {"key": "AYL_RUN_MODE", "value": "r2_probe"},
        ...
        {"key": "R2_PROGRESS_KEY", "value": "<generated>"},
        {"key": "R2_FINAL_REPORT_KEY", "value": "<generated>"},
...
def intended_payload(args: argparse.Namespace, marker_nonce: str) -> dict:
    return {
        "test_id": TEST_ID,
        "purpose": "validate_latentsync_image_v1_1_entrypoint_r2_probe_without_dockerargs",
...
def run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        if not execute_allowed:
            ...
            print("RunPod LatentSync image V1.1 entrypoint R2 probe dry-run created. No mutation sent and no Pod created.")
            print(f"Intended payload written: {INTENDED_PAYLOAD_PATH}")
            print(f"Log written: {LOG_PATH}")
            return 0

        trace("START execute mode")
        trace(f"CONFIG image={args.image_tag} gpu_type_id={args.gpu_type_id} timeout={args.max_wait_seconds}s run_mode=r2_probe")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dry-run or execute the LatentSync image V1.1 entrypoint R2 probe.")
