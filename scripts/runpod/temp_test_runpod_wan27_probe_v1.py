...
DEFAULT_POD_NAME = "ayl-test-wan27-probe-v1"
DEFAULT_IMAGE_TAG = "ghcr.io/fernandoreisdasilva/ayl-wan27-runpod:0.1.0"
DEFAULT_CONTAINER_DISK_GB = 60
RUN_MODE = "wan27_probe"

R2_PROGRESS_KEY = "tests/runpod_wan27_probe_v1/progress/container_started.json"
R2_FINAL_REPORT_KEY = "tests/runpod_wan27_probe_v1/output/final_report.json"
R2_INPUT_REFERENCE_IMAGE_KEY = "tests/runpod_wan27_probe_v1/input/mae_reference.png"
R2_INPUT_AUDIO_KEY = "tests/runpod_wan27_probe_v1/input/audio.wav"
R2_INPUT_SOURCE_VIDEO_KEY = "tests/runpod_wan27_probe_v1/input/mae_5s.mp4"
R2_OUTPUT_VIDEO_KEY = "tests/runpod_wan27_probe_v1/output/video_out.mp4"
...
CREATE_POD_MUTATION = """
mutation TestRunpodWan27ProbeV1Create($input: PodFindAndDeployOnDemandInput!) {
...
mutation TestRunpodWan27ProbeV1Terminate($podId: String!) {
...
def redacted_env(args: argparse.Namespace | None = None) -> list[dict]:
    ...
    return [
        ...
        {"key": "WAN27_DURATION_SECONDS", "value": "5"},
        {"key": "WAN27_RESOLUTION", "value": "480p"},
        ...
        {"key": "R2_INPUT_SOURCE_VIDEO_KEY", "value": R2_INPUT_SOURCE_VIDEO_KEY},
...
def intended_payload(args: argparse.Namespace, marker_nonce: str) -> dict:
    return {
        "test_id": TEST_ID,
        "purpose": "validate_wan27_runpod_community_r2_probe_v1_without_network_volume",
        ...
        "r2_input_keys": {
            "reference_image": R2_INPUT_REFERENCE_IMAGE_KEY,
            "audio": R2_INPUT_AUDIO_KEY,
            "source_video": R2_INPUT_SOURCE_VIDEO_KEY,
        },
        "planned_image_note": "Image must provide WAN27_COMMAND or an equivalent baked-in runtime command for a true WAN 2.7 run.",
...
def run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        if not execute_allowed:
            ...
            print("RunPod WAN 2.7 probe V1 dry-run created. No mutation sent and no Pod created.")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dry-run or execute the WAN 2.7 RunPod Community + R2 probe V1.")
