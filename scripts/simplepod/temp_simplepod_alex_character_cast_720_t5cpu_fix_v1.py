...
import temp_simplepod_run_mae_wan22_s2v_14_8s_1080_blackwell_natural_v5 as base
...
def run(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        with timer.phase("poll_async_inference_job"):
            data["async_job_poll_result"] = base.poll_async_job(proxy_url, submission["job_id"], args)
