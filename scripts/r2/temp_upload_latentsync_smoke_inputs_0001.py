...
TEST_ID = "TEST_R2_LATENTSYNC_SMOKE_UPLOAD_0001"
REPO_ROOT = Path(__file__).resolve().parents[2]
ENV_PATH = REPO_ROOT / ".env"
LOG_PATH = REPO_ROOT / "logs" / "r2_latentsync_smoke_upload_0001_log.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Dry-run or upload required LatentSync smoke inputs to R2.")
